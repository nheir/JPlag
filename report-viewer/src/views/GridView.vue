    ...
    <div class="container">
        <div class="column-container" style="width: 30%">
            ...
            <div id="basicInfo">
                ...
                <TextInformation :has-additional-info="true" :value="overview.language"
                    additional-info-title="File extensions:" label="Language">
        ...
        <div class="column-container" style="width: 100%">
            <div id="metrics">
                ...
                <div id="metrics-list">
                    <MetricButton v-for="(metric, index) in overview.metrics" :id="metric.metricName"
                        :key="metric.metricName" :is-selected="selectedMetric[index]" :metric="metric"
                        @click="selectMetric(index)" />
                </div>
            </div>
            <GridTable :overview="overview" :topComps="topComps[selectedMetricIndex]" class="full-width" />
        </div>
    </div>
</template>
